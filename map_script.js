...
let imgs = ['content/img/acidalia_planitia.png', 'content/img/gale.png', 'content/img/olympus_mons.png', 'content/img/valles_marineris.png']
let app = new Vue({
    el: '#app',
    data: {
      ...
      img: "content/img/acidalia_planitia.png"
    },
    methods: {
